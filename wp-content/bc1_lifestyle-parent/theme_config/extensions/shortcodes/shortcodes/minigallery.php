...
global $uniq;
    ...
    $out .= '
    <div class="minigallery-list box border box_white ' . $class . '">
    <a class="prev">prev</a><a class="next">next</a><div class="minigallery" ><ul>';
     ...
     foreach ($attachments as $id => $attachment)
    {
        ...
        if ( $pretty != 'false')
            $out .= '<li><a href="' . $image_link_attach . '" rel="prettyPhoto[gallery' . $uniq . ']" title="">'. $img . $icon_plus . '</a></li>';
        else
            $out .= '<li>' . $img . '</li>';
    }
