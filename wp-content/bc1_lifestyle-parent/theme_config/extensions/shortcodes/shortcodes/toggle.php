...
function tfuse_toggle_content($atts, $content = null)
{
    ...
    return '<div class="clear"></div><h3 class="toggle box ' . $class . '">' . $title . '<span class="ico"></span></h3>
        <div class="toggle_content"><p>' . do_shortcode($content) . '</p></div>';
}
...
class TFUSE_Code_Shortcode {
  ...
  static  function print_script() {
        ...
        echo '<script type="text/javascript">SyntaxHighlighter.defaults[\'gutter\'] = false;SyntaxHighlighter.defaults[\'toolbar\'] = true;SyntaxHighlighter.all();</script>';
    }
  ...
  static  function tfuse_toggle_code($atts, $content = null) {
        ...
        $out = '<div class="clear"></div><h3 class="toggle box">' . $title . '<span class="ico"></span></h3>';
   ...
   static function tfuse_code($atts, $content = null) {
        ...
        return '<div class="clear"></div><pre class="brush: ' . $brush . '">' . $content . '</pre>';
    }
