                ...
                array(
                    ...
                    'options' => array(
                        array('name' => 'Title',
                            ...
                            'divider' => true),
                        array('name' => 'Subtitle',
                            'desc' => 'The Subtitle is displayed on the image and will be visible by the users',
                            'id' => 'slide_subtitle',
                            'value' => '',
                            'type' => 'text',
                            'divider' => true),
                        array('name' => 'TAB Title',
                            'desc' => 'Tab Title',
                            'id' => 'slide_tab_title',
                            'value' => '',
                            'type' => 'text',
...
$options['extra_options'] = array(
    array('name' => 'Slide Subtitle',
        'desc' => 'If the image from this post is gonna be fetched in one of the Sliders, the image needs to have a custom Subtitle in the slider. Please input one.',
        'id' => TF_THEME_PREFIX . '_slide_subtitle',
        'value' => '',
        'type' => 'text'),
        array('name' => 'Slide Tab Title',
        'desc' => 'If the image from this post is gonna be fetched in one of the Sliders, the image needs to have a custom Tab Title in the slider. Please input one.',
        'id' => TF_THEME_PREFIX . '_slide_tab_title',
        'value' => '',
        'type' => 'text')
);
?>