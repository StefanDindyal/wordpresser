...
$cfg['setup'] = array(
    array(
        'design' => 'featurelist-vertical',
        'name' => 'featurelist-vertical'
    ),
    array(
        'design' => 'featurelist-horizontal',
        'name' => 'featurelist-horizontal'
    )
);
            ...
            'headings' => array(
                array(
                    ...
                    'options' => array(
                        array(
                            'name' => 'Slider Type',
                            'desc' => 'Choose the slider type. You can check the sliders in the <a target="_black" href="http://themefuse.com/demo/wp/lifestyle/">demo live preview</a> on our website.',
...
$cfg['extra_options'] = array(
    array('name' => 'Slide Subtitle',
        'desc' => 'Custom slide subtitle to owerite post excerpt.',
