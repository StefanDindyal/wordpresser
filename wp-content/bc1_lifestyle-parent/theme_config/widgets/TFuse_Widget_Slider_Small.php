...
class TFuse_slider_small extends WP_Widget {

	function TFuse_slider_small() {
		$widget_ops = array('description' => '' );
		parent::WP_Widget(false, __('TFuse - Slider Small', 'tfuse'),$widget_ops);
	}
	...
	function widget($args, $instance) {
        ...
        <script type="text/javascript">
			...
			<div class="boxs box_slider extra-col" id="small_slides_wight">
				<div id="small_slides" class="<?php echo $rand ?>">
					<div class="slides_container">
						...
						foreach ($posts as $key=>$val) {
							...
							if(isset($page))  {
                                ...
                                $tfuse_image = $image->width(220)->height(156)->src($ff)->get_img();
                                if($ff){
...
register_widget('TFuse_slider_small');
