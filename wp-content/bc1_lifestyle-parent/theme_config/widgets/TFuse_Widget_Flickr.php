...
class TFuse_Widget_Flickr extends WP_Widget {

	function TFuse_Widget_Flickr() {
	...
	function widget($args, $instance) {
            ...
            $before_widget = '<div class="box box_menu widget_flickr">';
            $after_widget = '</div>';

        echo $before_widget; ?>
        <div class="box box_flickr">
   ...
   function form($instance) {
		$instance = wp_parse_args( (array) $instance, array(  'flickr_id' => '51362473@N05', 'number' => '6') );
...
register_widget('TFuse_Widget_Flickr');
