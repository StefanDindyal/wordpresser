...
class TFuse_Widget_Pages extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( !empty( $out ) ) {
			echo '<div  class="box box_menu widget_pages">';
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('exclude'); ?>"><?php _e( 'Exclude:','tfuse','tfuse'); ?></label> <input type="text" value="<?php echo $exclude; ?>" name="<?php echo $this->get_field_name('exclude'); ?>" id="<?php echo $this->get_field_id('exclude'); ?>" class="widefat" />
			<br />
