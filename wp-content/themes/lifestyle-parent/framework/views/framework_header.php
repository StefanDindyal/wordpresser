...
<div id="tfuse_header">
    ...
    <div id="tfuse_header_theme_info">
        ...
        <div id="tfuse_header_icon_bg">
            <a href="http://www.themefuse.com" target="_blank" title="Go to ThemeFuse"><img class="header_icon" src="<?php echo tfuse_get_file_uri('images/thumb.png'); ?>" width="70%" height="70%" /></a>
        </div>

        <div id="tfuse_header_text">
            <h3><?php echo $this->theme->theme_name; ?></h3>
            <a href="http://www.themefuse.com" target="_blank" title="Go to ThemeFuse"><img src="<?php echo TFUSE_ADMIN_IMAGES . '/by_tfuse.png'; ?>" /></a>
