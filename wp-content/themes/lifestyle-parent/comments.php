...
<a href="#addcomments" class="link-addcomment"><?php _e('Add a comment', 'tfuse') ?></a>
<h2><?php _e('Comments', 'tfuse') ?> (<?php comments_number('0', '1', '%') ?>)</h2>
