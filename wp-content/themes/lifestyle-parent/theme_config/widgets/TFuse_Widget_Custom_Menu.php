...
class TFuse_Nav_Menu_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        $args['before_widget'] = '<div  class="box box_menu widget_nav_menu">';
    ...
    function update( $new_instance, $old_instance ) {
        ...
        if ( in_array( $new_instance['template'], array( 'box_white box_border', 'box_white' ) ) ) {
            $instance['template'] = $new_instance['template'];
        } else {
            $instance['template'] = 'box_white box_border';
        }
    ...
    function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array(  'template' => 'box_white box_border',) );
