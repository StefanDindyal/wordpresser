...
class TFuse_Widget_Text extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        $before_widget = '<div  class="box box_menu widget_text">';
        $after_widget = '</div>';
        $before_title = '<h3>';
        $after_title = '</h3>';
    ...
    function update( $new_instance, $old_instance ) {
        ...
        if ( in_array( $new_instance['template'], array( 'box_white', 'box_light_gray' ) ) ) {
            $instance['template'] = $new_instance['template'];
        } else {
            $instance['template'] = 'box_light_gray';
        }
    ...
    function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array( 'title' => '', 'text' => '', 'template' => '' ) );
