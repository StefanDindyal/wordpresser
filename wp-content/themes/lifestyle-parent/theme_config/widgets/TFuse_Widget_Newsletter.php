...
class TFuse_Widget_Newsletter extends WP_Widget {

    function TFuse_Widget_Newsletter() {
        ...
        <div class="newsletter_subscription_box newsletterBox">
            <div class="inner">
                ...
                <form action="#" method="post" class="newsletter_subscription_form">
                    ...
                    <input type="submit" value="" class="btn-arrow newsletter_subscription_submit" />
                    <div class="clear"></div>
                </form>
...
register_widget('TFuse_Widget_Newsletter');
