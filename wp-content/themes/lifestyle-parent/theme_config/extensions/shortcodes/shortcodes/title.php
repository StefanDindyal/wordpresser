...
{
    extract(shortcode_atts(array('type' => 'h2',  'class' => 'title_border'), $atts));
...
$atts = array(
    ...
    'options' => array(
        ...
        array(
            'name' => 'Class',
            'desc' => 'Specifies one or more class names for an shortcode. To specify multiple classes,<br /> separate the class names with a space, e.g. <b>"left important","Box Styles"</b>',
