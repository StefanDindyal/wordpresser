jQuery(function($) {
	...
	function my_check_categories(){
       ...
       $('#artist-page, #home-slider, #buy-link, #top-link').show();
   ...
   function enableVids(){
	   if ($('#MA_enablevid input[type="checkbox"]').is(':checked')){
	      $('#MA_avids').show();
	   } else {
	      $('#MA_avids').hide();
	   }
	...
	function enableDisc(){
	   if ($('#MA_enabledisc input[type="checkbox"]').is(':checked')){
	      $('#MA_disco').show();
	   } else {
	      $('#MA_disco').hide();
	   }
	...
	$('#MA_avids, #MA_disco').hide();
	$('#MA_enabledisc input[type="checkbox"]').click(function(){
	    enableDisc();
	});
	enableDisc();
	$('#MA_enablevid input[type="checkbox"]').click(function(){
	    enableVids();
	});
	enableVids();	
